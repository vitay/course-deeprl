...
No lectures in the summer semester. 

Research paper for the retake exam (26.07.24, 12:00-13:30, 1/204): 

> Burda, Y., Edwards, H., Storkey, A., & Klimov, O. (2018). Exploration by Random Network Distillation (arXiv:1810.12894). <https://arxiv.org/pdf/1810.12894>

Blog and videos: <https://openai.com/index/reinforcement-learning-with-prediction-based-rewards/>

At the exam, you can bring the paper printed one-sided (17 pages), with as many annotations as you want on the back of each page (including lecture notes). You should also prepare a 200 words abstract on a separate piece of paper (handwritten or printed) that you will give with the rest of your answers.
