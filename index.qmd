...
* Lecture: Wednesday 09:15-10:45 1/368a
* Exercise: Tuesday 13:45-15:15 B202

 
The first lecture is on 16.10.24, the first exercise one day before on 15.10.24. If not done already (e.g. in Neurocomputing), register here: 

<https://bildungsportal.sachsen.de/opal/auth/RepositoryEntry/18086756352/CourseNode/1693276028553462004>

before the first exercise to get login credentials that work in the FRIZ pool B202. 

The two first exercises will be a basic introduction to python and numpy, students which are familiar with python can skip these sessions.
:::

:::callout-note
### Exam

Mock exam: [pdf](https://www.tu-chemnitz.de/informatik/KI/edu/deeprl/HER2017.pdf)

At the exam, you can bring the paper printed one-sided, with as many annotations as you want on the back of each page (including lecture notes). You should also prepare a 200 words abstract on a separate piece of paper (handwritten or printed) that you will give with the rest of your answers.
