...
4. **Model-based RL**
    ...
    4. [Successor representations (optional)](notes/4.4-SR.qmd)
...
:::callout-note
**WS2023-24:** Here are the compressed slides for A3C/DDPG/PPO: [html](slides/3.8-A3C-DDPG-PPO.html){target="_blank"}. SAC is unfortunately skipped.
:::
...
13. [PPO](exercises/13-PPO-solution.ipynb)
