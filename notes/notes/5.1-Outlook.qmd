...
![Source: <https://ai.googleblog.com/2020/04/an-optimistic-perspective-on-offline.html>](../slides/img/offlinerl.gif)
...
![https://ai.googleblog.com/2020/08/tackling-open-challenges-in-offline.html](../slides/img/d4rl.png)
...
![@Bojarski2016](../slides/img/dave2-training.png)
...
Most offline RL methods are **conservative** methods, which try to learn policies staying close to the known distribution of the data. See @Levine2020 for a review. Examples:

* Batch-Contrained deep Q-learning (model-free) [@Fujimoto2019]
* MOREL (model-based) [@Kidambi2021]

![Source: <https://kenshinhm.tistory.com/37>](../slides/img/morel.png)
...
The **decision transformer** [@Chen2021] takes complete offline trajectories as inputs (s, a, r, s...) and predicts autoregressively the next action.

![Source: @Chen2021](../slides/img/decisiontranformer.png)


However, transformers will mostly shine when used as World models... See @Micheli2022.

![Source: @Micheli2022](../slides/img/transformer-rl1.png){width=70%}

![Source: @Micheli2022](../slides/img/transformer-rl2.png){width=60%}
