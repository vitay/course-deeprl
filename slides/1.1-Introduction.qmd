...
![Source: <https://sites.google.com/site/acrader4th2014/home/part-3-unity-and-diversity-of-life/trialanderrorlearning>](img/trialerror.jpg)
...
# Applications of RL : Optimal control
...
# Applications of RL : Board games (Backgammon, Chess, Go, etc)
...
# Applications of RL : Atari games
...
# Applications of RL : simulated cars
...
# Applications of RL : real robotics
...
# Applications of RL : learning dexterity
...
# Applications of RL : Dota2 (OpenAI)
...
# Applications of RL : Starcraft II (AlphaStar)
...
2. **Basic RL**
    ...
    6. Temporal difference, Eligibility traces
    7. Function approximation, deep learning
...
3. **Model-free RL**
    ...
    2. Advantage Actor-critic (A3C)
    3. Deterministic policy gradient (DDPG)
    5. Natural gradients (TRPO, PPO)
    6. Maximum Entropy RL (SAC)
...
5. **Outlook**
    ...
    1. Hierarchical RL, Inverse RL, Meta RL
