...
![Source: David Silver. <http://www0.cs.ucl.ac.uk/staff/d.silver/web/Teaching.html>](img/maze.png)
...
![Source: David Silver. <http://www0.cs.ucl.ac.uk/staff/d.silver/web/Teaching.html>](img/maze-value.png)
...
![Source: David Silver. <http://www0.cs.ucl.ac.uk/staff/d.silver/web/Teaching.html>](img/maze-policy.png)
...
![Source: Andrew Ng, Stanford CS229, <https://see.stanford.edu/materials/aimlcs229/cs229-notes1.pdf>](img/supervisedlearning.png){width=55% fig-align="center"}
...
![Source: David Silver. <http://www0.cs.ucl.ac.uk/staff/d.silver/web/Teaching.html>](img/rl-loop.png){width=80% fig-align="center"}
...
![](img/discrete.png){fig-align="center"}
...
::: footer
@Mnih2013 Playing Atari with Deep Reinforcement Learning. NIPS. <http://arxiv.org/abs/1312.5602>
:::
...
::: footer
@Degrave2022 Magnetic control of tokamak plasmas through deep reinforcement learning. Nature, 602(7897). doi/10.1038/s41586-021-04301-9
:::
...
::: footer
@Roy2022 PrefixRL: Optimization of Parallel Prefix Circuits using Deep Reinforcement Learning. doi:10.1109/DAC18074.2021.9586094
:::
