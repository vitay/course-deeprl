...
![](img/narmedbandit2.jpg){width=50% fig-align="center"}
...
![](img/bandit-nonstationary1.png){fig-align="center"}
...
![](img/bandit-nonstationary2.png){width=70% fig-align="center"}
...
![](img/bandit-estimates-epsilongreedy.png){fig-align="center"}
...
![](img/bandit-estimates-softmax.png){fig-align="center"}
...
![](img/bandit-estimates-softmax2.png){fig-align="center"}
...
![](img/bandit-greedy.gif){fig-align="center"}
...
![](img/bandit-egreedy.gif){fig-align="center"}
...
![](img/bandit-softmax.gif){fig-align="center"}
...
![](img/bandit-comparison1.png){fig-align="center"}

:::
::: {.column width=50%}


![](img/bandit-comparison2.png){fig-align="center"}
...
![](img/bandit-reinforcementcomparison.gif){fig-align="center"}
...
![Source: <https://medium.com/emergent-future/simple-reinforcement-learning-with-tensorflow-part-1-5-contextual-bandits-bff01d1aad9c>](img/bandit-hierarchy.png){fig-align="center"}
...
![Source: <https://aws.amazon.com/blogs/machine-learning/power-contextual-bandits-using-continual-learning-with-amazon-sagemaker-rl/>](img/contextualbandit.gif){fig-align="center"}
