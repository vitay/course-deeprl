...
::: footer
Mnih et al. (2015). Human-level control through deep reinforcement learning. Nature 518, 529–533. doi:10.1038/nature14236.
:::
...
::: footer
van Hasselt, Guez and Silver (2015). Deep Reinforcement Learning with Double Q-learning, arXiv:1509.06461.
:::
...
![](img/ddqn-results1.png){width=100%}
...
![Source: <https://parksurk.github.io/deep/reinfocement/learning/drlnd_2-4_value_based_methods-post/>](img/replaybuffer.png){width=70%}
...
![Source: <https://www.freecodecamp.org/news/improvements-in-deep-q-learning-dueling-double-dqn-prioritized-experience-replay-and-fixed-58b130cc5682/>](img/per_tree.png){width=80%}
