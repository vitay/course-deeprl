...
author: Julien Vitay - Professur für Künstliche Intelligenz - Fakultät für Informatik
author: Julien Vitay
...
![Source: <https://www.freecodecamp.org/news/an-introduction-to-policy-gradients-with-cartpole-and-doom-495b5ef2207f/>](img/dqn-pg.png)



# Policy search

![](img/policysearch.svg){width=40%}
...
::: footer
Mao, H., Alizadeh, M., Menache, I., and Kandula, S. (2016). Resource Management with Deep Reinforcement Learning. HotNets ’16 doi:10.1145/3005745.3005750.
:::
...
![](img/policygradient.svg)

# Policy Gradient : Actor-critic


![](img/policygradient.svg){width=40%}
