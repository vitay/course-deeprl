...
* Model-free methods allow to solve MDPs without knowing anything about the model. They differ regarding the type of action spaces they allow, their method of exploration and learning (on- or  off-policy), their sample efficiency, learning stability and optimality.
...
* In practice, you should use PPO if you do not really care about sample efficiency and prefer learning stability (ChatGPT). For continuous robotics, you should prefer TD3 or SAC, TD3 being less computationally expensive, but SAC being more sample efficient.
...
![](img/learningdynamics.png){width=60%}
